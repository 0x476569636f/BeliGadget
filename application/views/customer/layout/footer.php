<footer style="background: #ffffff;border-top: 5px solid #333333;" class="footer sticky-bottom pt-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5 mb-4">
                ...
                <p>
                    Toko Online Beli Gadget Terpercaya di Indonesia. Beli Aman & Harga Termurah! Belanja
                    sekarang.
                </p>
                <div class="social">
            ...
            <div class="col-md-3 mb-4">
                <h4 class="font-weight-bold">MENDUNGKUNG PEMBAYARAN</h4>
                <hr style="border-top: 3px solid rgb(226 232 240);border-radius:.5rem">
                <div class="row">
